...
1. ナレッジベースに格納された情報システムの設計書から与えられた要件に関連する内容を検索してください。
...
結果は必ず以下のフィールドで構成された json オブジェクトとして出力してください。
...
If you are unable to determine which function to call or if you are unable to generate a query, please tell me why you can't, and what enables you to do it.
